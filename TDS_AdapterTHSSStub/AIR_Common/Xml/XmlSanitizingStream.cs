...
namespace AIR.Common.Xml
{
    ...
    /// </summary>
    /// <remarks>http://prettycode.org/2009/05/07/hexadecimal-value-0x-is-an-invalid-character/</remarks>
    public class XmlSanitizingStream : StreamReader
    {
        ...
        /// <summary>
        /// Create an instance of XmlSanitizingStream.
        /// </summary>
        /// <param name="streamToSanitize">
        /// The stream to sanitize of illegal XML characters.
        /// </param>
        public XmlSanitizingStream(Stream streamToSanitize) : base(streamToSanitize, true) { }
        ...
        public override int Peek()
        {
            ...
            while
            (
                // If it's prohibited XML, skip it and try next
                !IsLegalXmlChar(nextCharacter) && (nextCharacter = base.Read()) != EOF
            );
