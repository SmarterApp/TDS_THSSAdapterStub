    ...
    public class XmlFragmentReader : XmlWrappingReader
    {
        ...
        public override ReadState ReadState
        {
            get
            {
                ...
                if (baseState == ReadState.Initial || baseState == ReadState.EndOfFile)
                {
                    return state;
                }
        ...
        public override XmlNodeType NodeType
        {
            get
            {
                if (isRoot) return nodeType;
                else return base.NodeType;
            }
        }
        ...
        public override string LocalName
        {
            get
            {
                if (isRoot) return rootName.Name;
        ...
        public override string NamespaceURI
        {
            get
            {
                if (isRoot) return rootName.Namespace;
